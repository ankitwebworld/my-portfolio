document.addEventListener('DOMContentLoaded', function(event) {
    ...
    resetPasswordButton.addEventListener('click', function(event) {
        ...
        resetPasswordButton.textContent='sending otp...'
        ...
        .catch(error => {
            ...
            resetPasswordButton.textContent= error.message
        });
    });
...
function otpSection() {
    ...
    VerifyOTP.addEventListener('click', (event) => {
        ...
        fetch('/verify-user-forgot-password-otp', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
function changePassword() {
    ...
    async function submitPassword() {
        ...
        const response = await fetch('/change-user-password-reset', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
